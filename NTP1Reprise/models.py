...
class Personnegrcntp1(models.Model):
    codeGRC = models.IntegerField(verbose_name="ID")
    province = models.ForeignKey(Province, on_delete=models.DO_NOTHING)
    ...
    newpresencefps = models.BooleanField(verbose_name=_("Présence de FPS en 2022/23. Cocher si oui"))
...
class NouveauxDelitsntp1(models.Model):
    ...
    codeCCdelit = models.CharField(max_length=50, verbose_name=_("Code CC du delit (si pas CC preciser de quel code il s agit)"))
    ...
    amendecout = models.IntegerField(default=0,verbose_name=_("Cout total de l'amende"), null=True, blank=True)
    detentionON = models.BooleanField(verbose_name=_("Détention? Cocher si oui"))
    detentionduree = models.IntegerField(default=0, verbose_name=_("Durée de la détention"), null=True, blank=True)
    ...
    interdictiondetails = models.CharField(max_length=150, verbose_name=_("Détails à propos de l'interdicttion"), null=True, blank=True)
