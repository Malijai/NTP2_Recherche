...
class Personnegrcntp1(models.Model):
    codeGRC = models.CharField(max_length=50, verbose_name="ID")
    ...
    newpresencefps = models.BooleanField(verbose_name=_("Présence de FPS. Cocher si oui"), blank=True, null=True)
