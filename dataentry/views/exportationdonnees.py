...
@login_required(login_url=settings.LOGIN_URI)
def OLD_ffait_csv(request, province, questionnaire):
...
## Necessite d'utiliser le streaming pour exporter les données par province et questionnaire pour tous les cas
@login_required(login_url=settings.LOGIN_URI)
